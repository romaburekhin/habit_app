...
export default function HabitList({ habits, completions, loading, error, onEdit, onToggleDay }: Props) {
      ...
      {habits.map(habit => {
        ...
        return (
          <li
            ...
            className={`rounded-2xl border px-3 py-2 cursor-pointer transition-all ${
              habit.color
          ...
          >
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              {habit.streak > 0 && (
                <span
                  ...
                  className={`text-[11px] ml-2 shrink-0 ${pct >= 100 ? (habit.color ? '' : 'text-emerald-600 font-medium') : 'text-gray-400'}`}
                >
            ...
            {/* Week day circles */}
            <div
              className="flex gap-1.5 sm:gap-2.5 justify-center mb-2"
